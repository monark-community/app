...
const CHAT_EVENT_TYPES = {
  "chat.conversation-created": {
    ...
    fields: [
      { key: "organizationId", type: "string", description: "The organization the conversation belongs to." },
  ...
  "chat.message-created": {
    ...
    fields: [
      { key: "organizationId", type: "string", description: "The organization the message belongs to." },
      ...
      { key: "actorId", type: "string", description: "The human author, or null for AI_AGENT / TOOL." },
    ],
  },
} as const;
