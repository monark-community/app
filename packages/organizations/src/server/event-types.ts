...
const ORGANIZATIONS_EVENT_TYPES = {
  ...
  "organization.member-removed": {
    description:
      "A user was removed from an organization, either self-service or by an admin.",
  },
  "organization.invite-sent": {
    description:
      "An admin invited an external email to join the organization at a specific role.",
  },
