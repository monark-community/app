...
const AUTH_EVENT_TYPES = {
  ...
  "trusted-device.added": {
    description:
      "A new device was recognized + persisted on first sign-in from that device.",
  },
  ...
  "totp.enabled": {
    description:
      "The user confirmed TOTP enrollment. Their account now requires a second factor.",
  },
  "totp.disabled": {
    description:
  ...
  "totp.recovery-code-used": {
    description:
      "A recovery code was consumed (one-time, can never be re-used).",
  },
} as const
