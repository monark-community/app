...
Based on the shipped Phase 0 specification ; see [features-planning/phase-0/modular-architecture.md](../../features-planning/phase-0/modular-architecture.md) and [project-scaffolding.md](../../features-planning/phase-0/project-scaffolding.md) for the full design rationale. For the **authoritative as-is** module inventory (16 core + 8 extended), boot sequence, and per-capability detail, see [platform-overview.md](../platform-overview/_index.md) ; for the extension contract ("can a feature ship without touching core?"), see [extensibility-contract.md](../extensibility-contract/_index.md).

## In this section

- **[Two-tier module system](two-tier-module-system.md)**
- **[Directory tree](directory-tree.md)**
- **[Infrastructure packages](infrastructure-packages.md)**
- **[Codegen tools](codegen-tools.md)**
