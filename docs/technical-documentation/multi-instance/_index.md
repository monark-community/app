...
Each instance is a normal production deploy (the [deploy-checklist.md](../deploy-checklist/_index.md)
...
- **[What differs per instance](what-differs-per-instance.md)**
- **[Two instances on one dev machine](two-instances-on-one-dev-machine.md)**
...
8. Smoke-test against the client domain ([deploy-checklist.md](../deploy-checklist/_index.md) Phase 4).
