...
![The rail down the left edge : the brand mark at the top, one icon per destination with the current section highlighted, and the admin shield pinned at the bottom.](../../assets/navigation-rail.png)
