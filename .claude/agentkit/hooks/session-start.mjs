...
try {
  ...
  lines.push(
    `- **Port slot ${slot}**: ${Object.entries(ports)
      ...
      .join(', ')}. These are already written into this worktree's env files; use them in every URL, curl and browser check. Do not assume the default ports; another worktree owns those.`,
  )
