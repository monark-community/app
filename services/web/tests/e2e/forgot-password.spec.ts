...
test.describe("forgot password full flow", () => {
  ...
  test(
    "request reset → click email link → submit new password → sign in",
    async ({ page }) => {
