  ...
  if (!edit) {
    ...
    const trigger = (
      <button
        type="button"
        aria-label={
          bannerUrl ? edit.labels.bannerEditAria : edit.labels.bannerUploadAria
        }
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" sideOffset={8}>
            ...
            >
              ...
              <span>
                {edit.bannerPending
                  ? edit.labels.bannerUploading
                  : edit.labels.bannerReplace}
              </span>
            </DropdownMenuItem>
            <DropdownMenuSeparator />
            <DropdownMenuItem
  ...
  if (edit) {
    const trigger = (
      <button
        type="button"
        aria-label={
          avatarUrl ? edit.labels.avatarEditAria : edit.labels.avatarUploadAria
        }
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="start" sideOffset={8}>
              ...
              >
                ...
                <span>
                  {edit.avatarPending
                    ? edit.labels.avatarUploading
                    : edit.labels.avatarReplace}
                </span>
              </DropdownMenuItem>
              <DropdownMenuSeparator />
              <DropdownMenuItem
