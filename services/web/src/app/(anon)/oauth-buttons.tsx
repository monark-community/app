 ...
 * party watching an unauthenticated page load. Google and Microsoft
 * require their exact brand colours, so those two ignore `currentColor`
 * on purpose ; GitHub's mark is monochrome and follows the button's
 * text colour.
 */
